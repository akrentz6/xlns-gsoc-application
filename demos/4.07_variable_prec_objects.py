"""
See section 4.7: Variable Precision XLNS Objects
Adds support for operations between LNSTensor
and the variable precision xlns objects (xlnsv,
xlnsnpv, xlnsb, xlnsnpb). This requires us to
store a base in each LNSTensor instance.
"""
import functools
import contextlib
import numpy as np
